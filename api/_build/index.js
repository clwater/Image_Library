...
var client;
function initClient(accessKeyId, accessKeySecret, bucket) {
  client = new OSS({
...
// route-module:D:\code\my\Image_Library\app\routes\list.tsx
var OSS2 = require("ali-oss");
var loader = async () => {
  initClient(process.env.accessKeyId, process.env.accessKeySecret, process.env.bucket);
...
function List() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", null, "Posts"), data.ShowDir.map((subDir) => /* @__PURE__ */ React.createElement("li", null, subDir)), /* @__PURE__ */ React.createElement("div", null, "------------"), data.ShowFile.map((file) => /* @__PURE__ */ React.createElement("li", null, file.name))), /* @__PURE__ */ React.createElement("div", {
    onClick: testClick
  }, "Test"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_remix4.Outlet, null))));
}
